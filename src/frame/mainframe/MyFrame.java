...
public class MyFrame extends JFrame {
    ...
    class ButtonPanel extends JPanel {
        ...
        private void bindActions() {
            loadButton.addActionListener(e -> videoBase.readFrom(filenamePrompt.getFilenameInput()));
            saveButton.addActionListener(e -> videoBase.writeTo(filenamePrompt.getFilenameInput()));

            addButton.addActionListener(e -> {
                Video newVideo = newItemPrompt.getNewItem();
