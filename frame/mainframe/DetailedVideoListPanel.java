...
public class DetailedVideoListPanel extends JPanel implements MyObserver {
    ...
    public void update(Object o) {
        refreshPanels((List<Pseudovideo>) o);
    }

    public void refreshPanels(List<Pseudovideo> videos) {
        removeAll();
...
class VideoDetailPanel extends JPanel {
    ...
    private Pseudovideo video;
    private int nthOrder;

    public VideoDetailPanel(Pseudovideo v, int nth) {
        video = v;
        nthOrder = nth;
