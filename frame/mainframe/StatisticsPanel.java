...
public class StatisticsPanel extends JPanel implements MyObserver {
    ...
    public void update(Object o) {
        writeStatistics((List<Pseudovideo>) o);
    }
    ...
    public void writeStatistics(List<Pseudovideo> videos) {
        Pseudovideo mostViewed = VideoListSummarizer.findMostViewedVideo(videos);
        Pseudovideo leastViewed = VideoListSummarizer.findLeastViewedVideo(videos);
