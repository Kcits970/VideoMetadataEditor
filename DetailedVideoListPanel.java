...
class VideoDetailsPanel extends JPanel {
    ...
    public void addLabels() {
        ...
        titleLabel.setFont(MyWindowTools.ARIAL_UNICODE_18);
        ...
        uploaderLabel.setFont(MyWindowTools.ARIAL_UNICODE_14);
        ...
        numericalViewsLabel.setFont(MyWindowTools.ARIAL_UNICODE_18);
        numericalViewsLabel.setHorizontalAlignment(SwingConstants.RIGHT);

        JLabel literalViewsLabel = new JLabel("view(s)");
        literalViewsLabel.setFont(MyWindowTools.ARIAL_UNICODE_14);
